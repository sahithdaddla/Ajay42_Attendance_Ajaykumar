...
const allowedOrigins = [
    'http://13.49.44.9:8051', // Frontend
    'http://13.49.44.9:8052', // HR Page
    'http://13.49.44.9:3427', // Backend
    'http://localhost:3019',
    'http://127.0.0.1:5501',
    'http://127.0.0.1:5503'
];
...
async function startServer() {
    try {
        ...
        app.listen(port, '0.0.0.0', () => {
            ...
            console.log(`Health check: http://13.49.44.9:${port}/health`);
            console.log(`HR Dashboard: http://13.49.44.9:${port}/attendance.html`);
            console.log(`Employee Attendance: http://13.49.44.9:${port}/employee_attendance.html`);
        });
    } catch (err) {
