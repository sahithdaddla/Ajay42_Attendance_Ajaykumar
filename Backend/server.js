...
const allowedOrigins = [
    'http://16.170.246.73:8051', // Frontend
    'http://16.170.246.73:8052', // HR Page
    'http://16.170.246.73:3427', // Backend
    'http://localhost:3019',
    'http://127.0.0.1:5501',
    'http://127.0.0.1:5503'
];
...
async function startServer() {
    try {
        ...
        app.listen(port, '0.0.0.0', () => {
            ...
            console.log(`Health check: http://16.170.246.73:${port}/health`);
            console.log(`HR Dashboard: http://16.170.246.73:${port}/attendance.html`);
            console.log(`Employee Attendance: http://16.170.246.73:${port}/employee_attendance.html`);
        });
    } catch (err) {
